@php
    $isTinymistPage = (($page->editor ?? '') === \BookStack\Entities\Tools\PageEditorType::Tinymist->value);
    $newFileExtensions = \BookStack\Extensions\Tinymist\Attachments\TinymistBlankAttachmentFileService::getBlankFileExtensions();
@endphp
...
<div style="display: block;"
    ...
    data-tinymist-new-file-exists-message="{{ trans('entities.attachments_new_file_exists') }}"
    ...
    <div component="dropzone"
        ...
        <div refs="attachments@list-container dropzone@drop-target" class="relative">
            ...
            <div class="flex-container-row">
                ...
                @if($isTinymistPage)
                    <button type="button" data-tinymist-attachment-action="new-file" class="button outline small">{{ trans('entities.attachments_new_file') }}</button>
                @endif
            </div>
            <div>
            ...
            <div refs="attachments@list-panel" data-tinymist-attachment-list-panel="true">
    ...
    @if($isTinymistPage)
        <div id="new-file-form-container" hidden class="px-l" data-tinymist-attachment-new-file="true">
            @include('attachments.manager-new-file-form', [
                'pageId' => $page->id,
